...
# loading app image
app_lg  = Image.open("C:\salary.jpg")
...
# hourly wage
img_hour  = Image.open("C:\hour.png")
...
# salary per day
img_day  = Image.open("C:\salary.jpg")
...
# salary per week
img_week  = Image.open("C:\salary.jpg")
...
# salary per month
img_month  = Image.open("C:\salary.jpg")
...
# salary per year
img_year  = Image.open("C:\salary.jpg")
